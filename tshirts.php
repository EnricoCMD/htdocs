...
<style>
   ...
   <section id="Pullover">  <h1>T-Shirts</h1></section>
...
$sql = "SELECT * FROM produkte WHERE P_Kategorie='Tshirt'"; // Annahme: ID_B 1 wird verwendet, um den Benutzer abzurufen (du musst deine eigene Logik hier einsetzen)
